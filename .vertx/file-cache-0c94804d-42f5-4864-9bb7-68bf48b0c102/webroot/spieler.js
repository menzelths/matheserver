         ...
         if(event.which === 13){
            ...
            $("#knopf").trigger("click");
                ...
                for (var i=0;i<message.info.length;i++){
                    ...
                    var breite=400*message.info[i].richtig/anzahlAufgaben;
                    ctx.fillStyle="#00ff00";
                    ctx.fillRect(0,i*20,breite,15);
                    var breite2=400*(message.info[i].gesamt-message.info[i].richtig)/anzahlAufgaben;
