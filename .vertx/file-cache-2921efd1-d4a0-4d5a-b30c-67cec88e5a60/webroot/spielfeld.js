    ...
    eb.onopen = function () {
        ...
        eb.registerHandler('matheserver.spielfeld', function (message, replier) {
            ...
            if (typ === "id" && anmeldung === true) {
                ...
                var an=spielerListe2[i].holeAufgabenNummer();
                eb.send("matheserver.spieler."+spielerListe2[i].uuid,{typ:"neueAufgabe",wert:aufgaben[an],richtig:spielerListe2[nr].richtig,gesamt:spielerListe2[nr].gesamt,platz:-1});
            }
        });
    }
